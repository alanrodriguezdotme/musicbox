...
## Display settings                                                                     ##
n_cols = 16                 # EDIT!!!  <-- number of cols your display has              ##
n_rows = 2                  # EDIT!!!  <-- number of rows your display has              ##
...
info_at_lines_play[0] = 'artist'  # <-- Choose your favorite                           ##
info_at_lines_play[1] = 'title'  # <-- Choose your favorite                            ##
...
info_at_lines_pause[0] = 'artist'  # <-- Choose your favorite                           ##
info_at_lines_pause[1] = 'title'  # <-- Choose your favorite                            ##
